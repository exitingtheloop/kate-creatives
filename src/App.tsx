...
function App() {
  ...
  if (showAIAudit) {
    return <AIAudit onBack={handleBackToHome} />;
  }
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex space-x-12">
              {['Home', 'About', 'Services', 'Packages', 'Portfolio', 'Contact', 'Free AI Audit'].map((item) => (
                <button 
                  key={item}
                  onClick={() => {
                    if (item === 'About') {
                  ...
                  className={`transition-all duration-500 font-medium tracking-wide relative group ${
                    item === 'Free AI Audit' ? 'text-green hover:text-green font-bold' : isScrolled 
          ...
          <div className={`md:hidden absolute top-full left-0 w-full transition-all duration-500 ${
            ...
            <div className="px-6 py-8 space-y-6">
              {['Home', 'About', 'Services', 'Packages', 'Portfolio', 'Contact', 'Free AI Audit'].map((item, index) => (
                <button 
                  key={item}
                  onClick={() => {
                    if (item === 'About') {
                  ...
                  className={`block text-xl transition-all duration-300 font-medium animate-slide-in ${item === 'Free AI Audit' ? 'text-pink hover:text-green font-bold' : 'text-white hover:text-green'}`}
